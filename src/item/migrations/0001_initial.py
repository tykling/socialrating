    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The name of this Item', max_length=100)),
                ('slug', models.SlugField(help_text='The slug for this Item. Must be unique within the Category.')),
                ('category', models.ForeignKey(help_text='The Category on which this Item is based', on_delete=django.db.models.deletion.PROTECT, related_name='items', to='category.Category')),
            ],
            options={
                'ordering': ['name'],
            },
