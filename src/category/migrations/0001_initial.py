    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The plural name of this Category. Must be unique within the Team. Changing the name also changes the URL slug, which means old links will stop working.', max_length=100)),
                ('slug', models.SlugField(help_text='The slug for this Category. Must be unique within the Team.', max_length=100)),
            ...
            options={
                ...
                'permissions': (('add_item', 'Add Item belonging to this Category'), ('add_fact', 'Add Fact for this Category'), ('add_rating', 'Add Rating for this Category')),
            },
        ),
    ]
