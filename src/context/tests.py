...
class ContextViewTestCase(TeamViewTestCase):
    ...
    def setUp(self):
        ...
        # define other urls
        self.list_url = reverse("team:context:list", kwargs={'team_slug': self.team1.slug})
        self.create_url = reverse("team:context:create", kwargs={'team_slug': self.team1.slug})
        self.update_url = reverse("team:context:update", kwargs={
            'team_slug': self.team2.slug,
            'context_slug': self.team2_context3.slug,
        })
        self.delete_url = reverse("team:context:delete", kwargs={
            'team_slug': self.team2.slug,
            'context_slug': self.team2_context3.slug,
        })
